...
public class Controller {
    ...
    public void calculate() {
        ...
        for (Project project : PROJECTS.values()) {
            ...
            averageRatioUG += (project.getVolumeUnderground() * 100) / project.getVolumeAboveGround();
     ...
     */
    private void addRandomProjects(int howMany) throws Exception {
        ...
        for (int i = 0; i < howMany; i++) {
            ...
            System.out.println(addProject(new Project(num, 1, "Projektstrasse " + num, 8001 + i, "Zürich", "Besitzer" + i,
                    ...
                    "nichts spezielles", new ProjectData("src\\main\\resources\\kv" + j + ".csv"))));
